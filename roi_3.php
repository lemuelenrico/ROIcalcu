      ...
      <div class="jumbotron jumbotronaddcomp">
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-sm-8"> <!-- visuals -->
            <fieldset>
              <legend class="geofont centertext"><img class="centerlvlimg" src="images/snowlevels/level_3.png" width="60px">&nbsp;Results Details&nbsp;<img class="centerlvlimg" src="images/snowlevels/level_3.png" width="60px" ></legend>
