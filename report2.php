...
$pdf->Cell(0,7,"This report is generated on: {$currentDate}",1,1,'R');


$pdf->SetFont("Helvetica","B",23);
$pdf->setTextColor(71,195,220);
$pdf->Cell(0,10,"ROI of Company {$repCom} ",1,1,'L');


$pdf->Image("images/pdfexporting/ROIexpfirststate.png",13,45,0,32);
$pdf->Image("images/pdfexporting/ROIcontactsection.png",155,45,0,40,'PNG','https://openit.com/contact-us-2/');
...
$pdf->Cell(92,8,"Calculated ROI:",1,0,"C");
...
$pdf->setTextColor(65,115,121);
$pdf->Cell(47,8,"{$repAgree}",1,0,"L", true);
$pdf->SetFillColor(238,238,238);
$pdf->Cell(1,8,"",1,0, "C", true);
$pdf->Cell(6,8,"",1,0);
$pdf->Cell(1,8,"",1,0, "C", true);
...
$pdf->setTextColor(65,115,121);
$pdf->Cell(47,8,"{$repNoOfLic}",1,0,"L", true);
$pdf->SetFillColor(238,238,238);
$pdf->Cell(1,8,"",1,0, "C", true);
$pdf->Cell(6,8,"",1,0);
$pdf->Cell(1,8,"",1,0, "C", true);
...
$pdf->Cell(92,8,"Savings for Year 1:",1,0,"C");
$pdf->Cell(1,8,"",1,1, "C", true);
...
$pdf->Cell(47,8,"{$repLoc}",1,0,"L", true);
$pdf->SetFillColor(238,238,238);
$pdf->Cell(1,8,"",1,0, "C", true);
$pdf->Cell(6,8,"",1,0);
$pdf->Cell(1,8,"",1,0, "C", true);
...
$pdf->Cell(63,11,"{$repROI}%",1,0, "C");
$pdf->setTextColor(236,140,45);
$pdf->Cell(63,11,"{$numRepSav}",1,1, "C");
$pdf->SetFillColor(255,255,255);
$pdf->Cell(196,0.7,"",1,1,"C", true);
