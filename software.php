      ...
      <div class="jumbotron jumbotronaddcomp">
        <img class="pointermarg" src="images/pointer2.png">
          ...
          <div id="AppSelector1">
            ...
            <div class="form-group row openfont">
              ...
              <label for="costLicense" class="col-sm-2 col-form-label softlabel rightalgn openfont" required><span class="requiredclr">*</span>Contract Cost ($)</label>
              <div class="col-sm-4">
                  <!--  <input type="text" class="form-control midtxtbx" data-placement="bottom" data-toggle="tooltip" title="Currency value is either whole number or with two decimal places." pattern="^\d*(\.\d{0,2})?$"id="costLicense" placeholder="0"
                                name="costlicenses" autocomplete="off" required> -->
                <input type="text" class="form-control midtxtbx" data-placement="bottom" data-toggle="tooltip" id="costLicense" placeholder="0"
                        name="costlicenses" autocomplete="off" required>
              </div>
            </div>
          </div><!--colorsemiwhite-->
        ...
        <div id="AppSelector2">
            ...
            <div class="form-group row openfont">
              ...
              <label for="costLicense2" class="col-sm-2 col-form-label softlabel rightalgn openfont"><span class="requiredclr">*</span>Contract Cost ($)</label>
              <div class="col-sm-4">
                    <input type="text" class="form-control midtxtbx" data-placement="bottom" data-toggle="tooltip" id="costLicense2" placeholder="0"
...
-->
            ...
            <div class="form-group row openfont">
              ...
              <label for="costLicense3" class="col-sm-2 col-form-label softlabel rightalgn openfont"><span class="requiredclr">*</span>Contract Cost ($)</label>
              <div class="col-sm-4">
                    <input type="text" class="form-control midtxtbx" data-placement="bottom" data-toggle="tooltip" id="costLicense3" placeholder="0"
