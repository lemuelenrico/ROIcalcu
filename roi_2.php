        ...
        <div class="row">
          <div class="col-md-4 col-sm-4"> <!--for app details -->
            ...
            <div class="row actionpointsbuttonpad">
              ...
              <form action="ReportLevel_2.php" method="POST" target="_blank">
                  <!-- the following hidden input function as transitional variables for reporting-->
                ...
                <input type="hidden" name="repappname" value="<?php echo $applicationName ?>">
                  ...
                  <!--the folowing are subject to changes -->
                  <input type="hidden" name="reproi" value="<?php echo $truVal_2_ROI1 ?>">
                  <input type="hidden" name="repsav" value="<?php echo $truVal_2_Savings1 ?>">
                  <input type="hidden" name="reproi2" value="<?php echo $truVal_2_ROI2 ?>">
                  <input type="hidden" name="repsav2" value="<?php echo $truVal_2_Savings2 ?>">
                  <input type="hidden" name="reproi3" value="<?php echo $truVal_2_ROI3 ?>">
                  <input type="hidden" name="repsav3" value="<?php echo $truVal_2_Savings3 ?>">
            ...
            <fieldset>
              ...
              <div class="row charttopmarg">
                <div class="col-md-6 col-sm6 leftalgn whitefont">
                  ...
                  <div id="analbar">
                    <p><span class="analysishighlight">&#9632;</span> Your most expensive application is <span class="analysishighlight"><?php echo $maxapp; ?></span>. <br>
                      <span class="analysishighlight">&#9632;</span> You can reduce <span class="analysishighlight">$<?php echo number_format($maxappCostReductionLvl_2,2); ?></span> on
                ...
                <div class="col-md-6 col-sm6 leftalgn whitefont">
                  ...
                  <div id="analdon">
                    <p><span class="analysishighlight">&#9632;</span> Using Open iT LicenseAnalyzer<i>2019</i>&trade; Level 2, you can have a total of <span class="analysishighlight">$<?php echo number_format($level_2_overallSav,2); ?></span> estimated savings for 3 years.</p>
                      <a class "whitefont" target="_blank" href="https://openit.com/contact-us-2/get-a-representative-to-contact-you/">Ask an Open iT expert &raquo;</a><br><br>
                  </div>
    ...
    let thePieChart = new Chart(roiChartPie, {
      ...
      data:{
        ...
        datasets:[{
          label: 'ROI',
          data:[
            <?php echo round($truVal_2_Savings1); ?>,
    ...
    let theLineChart = new Chart(roiChartLine, {
      ...
      data:{
        ...
        datasets:[{
          ...
          data:[
            0,
            <?php echo round($truVal_2_ROI1); ?>,
            <?php echo round($truVal_2_ROI2); ?>,
            <?php echo round($truVal_2_ROI3); ?>
          ],
          borderColor:'#ec8c2d',
          hoverBorderWidth: 3,
